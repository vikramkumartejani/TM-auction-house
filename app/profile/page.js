    ...
    <>
      <DashboardLayout>
        ...
        <div className='overflow-hidden w-full max-w-[1270px] mx-auto flex items-start lg:flex-row flex-col gap-6'>
          <div className='w-full max-w-[904px]'>
            <div className='bg-[#111B1B] w-full rounded-t-[16px]'>
              <div className='relative'>
                <img src='/assets/profile-banner.png' alt='profile-banner' className='w-full rounded-t-[16px] h-[115px] md:h-[211px]' />
              ...
              <div className='px-3 sm:px-6 flex items-start justify-between gap-2'>
                ...
                <div>
                  <button onClick={() => setIsOpen(true)} className='mt-8 bg-[#093033] rounded-3xl pt-1 text-[#FFFFFF] text-[14px] sm:text-[18px] font-centraRegular flex items-center justify-center gap-1.5 h-[35px] sm:h-[44px] w-[130px] sm:w-[184px]'>
              ...
              <div className='px-3 sm:px-6 mt-[34px] flex items-center gap-4 md:gap-8 overflow-hidden '>
                {tabs.map((tab) => (
                  <button
                    key={tab.id}
                    onClick={() => setActiveTab(tab.label)}
                    className={`text-[14px] text-nowrap sm:text-[18px] sm:leading-[32px] border-b-2 pb-2 ${activeTab === tab.label
          ...
          <div className='w-full lg:w-fit flex flex-col gap-6 text-white'>
            <Notification />
            <YourComments />
          </div>
        </div>
